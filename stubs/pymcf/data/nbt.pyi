...
from typing import Any, Dict, Iterable, List, Mapping, Optional, Tuple, Union, TypeVar, Generic, Sequence
...
class NbtList(List[NbtData], NbtData):
    ...
    def extend(self, __sequence: Sequence[Union[NbtData, Any]]) -> None: ...
    def clear(self) -> None: ...
